...
Note that it is also possible to use thr [magrittr](https://cran.r-project.org/web/packages/magrittr/vignettes/magrittr.html) pipe line with all functions from `eemR`.
...
![](inst/images/README-unnamed-chunk-13-1.png)<!-- -->
