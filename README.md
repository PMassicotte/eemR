...
```
    ...
    ## Successfully exported 4 EEMs to /tmp/RtmpYbOu8X/file6d001259aa91.mat.
...
```
    ...
    ## Successfully exported 8 EEMs to /tmp/RtmpYbOu8X/file6d001259aa91.mat.
...
Note that it is also possible to use thr [magrittr](https://cran.r-project.org/web/packages/magrittr/vignettes/magrittr.html) pipe line with most functions from `eemR`.
...
![](inst/images/README-unnamed-chunk-14-1.png)<!-- -->
