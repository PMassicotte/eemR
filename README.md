...
Kothawala et al. (2013) have shown that a 2-fold dilution was required for sample presenting total absorbance &gt; 1.5. Accordingly, a message will warn the user if total absorbance is greater than this threshold.
...
#> Successfully exported 3 EEMs to /tmp/Rtmpckxadl/file7d5230eba58f.mat.

## It is also possible to export more than one object at time
eem_export_matlab(filename, eem, eem)
#> Successfully exported 6 EEMs to /tmp/Rtmpckxadl/file7d5230eba58f.mat.
```
