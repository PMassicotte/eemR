...
here::i_am("vignettes/introduction.qmd")
load(here::here("vignettes", "ife.rda"))
load(here::here("vignettes", "blank.rda"))

# load(quarto::project_path("vignettes", "ife.rda"))
# load(quarto::project_path("vignettes", "blank.rda"))
